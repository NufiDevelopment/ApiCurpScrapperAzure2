...
module.exports = {
    ...
    insert: function(data, table) {
        ...
        let fields = Object.keys(data).map(function(v) {return v;}).join(","),
          values = Object.values(data)
            ...
            .join(","),
          query = `INSERT INTO ${table}(${fields}) VALUES(${values});SELECT SCOPE_IDENTITY() as id;`;
    ...
    update: function(data, table, where_clause = "") {
        ...
        let set_clause = Object.keys(data).map(function(k) {
            ...
            query = `UPDATE ${table} SET ${set_clause} ${where_clause != "" ? `WHERE ${where_clause}` : ""}`;
    ...
    tabla: {
        consultarCurplog: 'nufisvc_consultacurp_log'
    }
};
